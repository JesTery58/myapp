<html lang="{{ app()->getLocale() }}">
    <head>
      ...
      <meta name="content-language" content="@yield('langCode')" />
      ...
      <script src="{{ asset('use.typekit.net/zjb5wvv.js') }}"></script>
        ...
        <link rel="stylesheet" href="{{ asset('public/vendor/hs-megamenu/src/hs.megamenu.css') }}">
        <link rel="stylesheet" href="{{ asset('public/vendor/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.css') }}">
        <link rel="stylesheet" href="{{ asset('public/vendor/custombox/dist/custombox.min.css') }}">
        <link rel="stylesheet" href="{{ asset('public/vendor/animate.css/animate.min.css') }}">
        <link rel="stylesheet" href="{{ asset('public/vendor/slick-carousel/slick/slick.css') }}">
        <link rel="stylesheet" href="{{ asset('public/vendor/dzsparallaxer/dzsparallaxer.css') }}">
        <link rel="stylesheet" href="{{ asset('public/vendor/cubeportfolio/css/cubeportfolio.min.css') }}">
    ...
    <body>
      <!-- Skippy -->
                ...
                <div id="logoAndNav" class="container-fluid">
                  ...
                  <nav class="js-mega-menu navbar navbar-expand-lg u-header__navbar">
                    ...
                    <div class="u-header__navbar-brand-wrapper">
                      <a class="navbar-brand u-header__navbar-brand" href="index-2.html" aria-label="Space">
                    ...
                    <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse py-0">
                      <ul class="navbar-nav u-header__navbar-nav">
                              ...
                              <ul class="row list-unstyled u-header__mega-menu-list">
                                <li class="col-sm-6 col-lg-2 u-header__mega-menu-col mb-3 mb-lg-0">
                                  ...
                                  <ul class="list-unstyled">
                                    <li><a class="nav-link u-header__sub-menu-nav-link px-0" href="https://htmlstream.com/preview/space-v1.1/html/pages/about-agency.html">About Agency</a></li>
                                    <li><a class="nav-link u-header__sub-menu-nav-link px-0" href="https://htmlstream.com/preview/space-v1.1/html/pages/about-start-up.html">About Start-Up</a></li>
                                    <li><a class="nav-link u-header__sub-menu-nav-link px-0" href="https://htmlstream.com/preview/space-v1.1/html/pages/services-agency.html">Services Agency</a></li>
                                    <li><a class="nav-link u-header__sub-menu-nav-link px-0" href="https://htmlstream.com/preview/space-v1.1/html/pages/services-start-up.html">Services Start-Up</a></li>
                                  </ul>
                                  <!-- End Links -->
                                </li>
                                ...
                                <li class="col-sm-6 col-lg-2 u-header__mega-menu-col mb-3 mb-lg-0">
                                  ...
                                  <!-- Links -->
                                  <ul class="list-unstyled">
                                    <li><a class="nav-link u-header__sub-menu-nav-link px-0" href="https://htmlstream.com/preview/space-v1.1/html/pages/careers.html">Careers</a></li>
                                    <li><a class="nav-link u-header__sub-menu-nav-link px-0" href="https://htmlstream.com/preview/space-v1.1/html/pages/careers-single.html">Careers Single</a></li>
                                    <li><a class="nav-link u-header__sub-menu-nav-link px-0" href="https://htmlstream.com/preview/space-v1.1/html/pages/hire-us.html">Hire Us</a></li>
                                  </ul>
                                  <!-- End Links -->
                                </li>
                                ...
                                <li class="col-sm-6 col-lg-2 u-header__mega-menu-col mb-3 mb-lg-0">
                                  ...
                                  <!-- Links -->
                                  <ul class="list-unstyled">
                                    <li><a class="nav-link u-header__sub-menu-nav-link px-0" href="https://htmlstream.com/preview/space-v1.1/html/pages/signin-simple.html">Signin Simple</a></li>
                                    <li><a class="nav-link u-header__sub-menu-nav-link px-0" href="https://htmlstream.com/preview/space-v1.1/html/pages/signup-simple.html">Signup Simple</a></li>
                                    <li><a class="nav-link u-header__sub-menu-nav-link px-0" href="https://htmlstream.com/preview/space-v1.1/html/pages/recover-account.html">Recover Account</a></li>
                                  </ul>
                                  <!-- End Links -->
                                </li>
                                ...
                                <li class="col-sm-6 col-lg-2 u-header__mega-menu-col mb-3 mb-sm-0">
                                  ...
                                  <!-- Links -->
                                  <ul class="list-unstyled">
                                    <li><a class="nav-link u-header__sub-menu-nav-link px-0" href="https://htmlstream.com/preview/space-v1.1/html/pages/contacts-agency.html">Contacts Agency</a></li>
                                    <li><a class="nav-link u-header__sub-menu-nav-link px-0" href="https://htmlstream.com/preview/space-v1.1/html/pages/contacts-business.html">Contacts Business</a></li>
                                  </ul>
                                  <!-- End Links -->
                                </li>
                                ...
                                <li class="col-sm-6 col-lg-2 u-header__mega-menu-col">
                                  ...
                                  <!-- Links -->
                                  <ul class="list-unstyled">
                                    <li><a class="nav-link u-header__sub-menu-nav-link px-0" href="https://htmlstream.com/preview/space-v1.1/html/pages/help.html">Help</a></li>
                                    <li><a class="nav-link u-header__sub-menu-nav-link px-0" href="https://htmlstream.com/preview/space-v1.1/html/pages/pricing.html">Pricing</a></li>
                                    <li><a class="nav-link u-header__sub-menu-nav-link px-0" href="https://htmlstream.com/preview/space-v1.1/html/pages/terms.html">Terms &amp; Conditions</a></li>
                                    <li><a class="nav-link u-header__sub-menu-nav-link px-0" href="https://htmlstream.com/preview/space-v1.1/html/pages/privacy.html">Privacy &amp; Policy</a></li>
                                  </ul>
                                  <!-- End Links -->
                                </li>
                                ...
                                <li class="col-sm-6 col-lg-2 u-header__mega-menu-col">
                                  ...
                                  <!-- Links -->
                                  <ul class="list-unstyled">
                                    <li><a class="nav-link u-header__sub-menu-nav-link px-0" href="https://htmlstream.com/preview/space-v1.1/html/pages/coming-soon.html">Coming Soon</a></li>
                                    <li><a class="nav-link u-header__sub-menu-nav-link px-0" href="https://htmlstream.com/preview/space-v1.1/html/pages/maintenance-mode.html">Maintenance Mode</a></li>
                                    <li><a class="nav-link u-header__sub-menu-nav-link px-0" href="https://htmlstream.com/preview/space-v1.1/html/pages/error-404.html">Error 404</a></li>
                                  </ul>
                                  <!-- End Links -->
                                </li>
                              </ul>
                          ...
                          <ul id="worksSubMenu" class="list-inline hs-sub-menu u-header__sub-menu mb-0" style="min-width: 220px;"
                            ...
                            <li class="dropdown-item hs-has-sub-menu">
                              ...
                              <ul id="navSubmenuWorksBoxedLayout" class="hs-sub-menu list-unstyled u-header__sub-menu u-header__sub-menu-offset" style="min-width: 220px;"
                                ...
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/portfolio/boxed-classic.html">Portfolio Classic</a>
                                </li>
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/portfolio/boxed-grid.html">Portfolio Grid</a>
                                </li>
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/portfolio/boxed-masonry.html">Portfolio Masonry</a>
                                </li>
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/portfolio/boxed-gallery.html">Portfolio Gallery</a>
                                </li>
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/portfolio/boxed-slider.html">Portfolio Slider</a>
                                </li>
                              </ul>
                              <!-- End Submenu (level 2) -->
                            </li>
                            ...
                            <li class="dropdown-item hs-has-sub-menu">
                              ...
                              <ul id="navSubmenuWorksFullWidthLayout" class="hs-sub-menu list-unstyled u-header__sub-menu u-header__sub-menu-offset" style="min-width: 220px;"
                                ...
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/portfolio/fullwidth-classic.html">Portfolio Classic</a>
                                </li>
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/portfolio/fullwidth-grid.html">Portfolio Grid</a>
                                </li>
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/portfolio/fullwidth-masonry.html">Portfolio Masonry</a>
                                </li>
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/portfolio/fullwidth-gallery.html">Portfolio Gallery</a>
                                </li>
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/portfolio/fullwidth-slider.html">Portfolio Slider</a>
                                </li>
                              </ul>
                              <!-- End Submenu (level 2) -->
                            </li>
                            ...
                            <li class="dropdown-item hs-has-sub-menu">
                              ...
                              <ul id="navSubmenuWorksSinglePage" class="hs-sub-menu list-unstyled u-header__sub-menu u-header__sub-menu-offset" style="min-width: 220px;"
                                ...
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/portfolio/single-page-simple.html">Single Page Simple</a>
                                </li>
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/portfolio/single-page-grid.html">Single Page Grid</a>
                                </li>
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/portfolio/single-page-masonry.html">Single Page Masonry</a>
                                </li>
                                <li class="dropdown-divider"></li>
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/portfolio/case-studies-simple.html">Case Studies Simple</a>
                                </li>
                              </ul>
                              <!-- End Submenu (level 2) -->
                            </li>
                          ...
                          <ul id="blogSubMenu" class="list-inline hs-sub-menu u-header__sub-menu mb-0" style="min-width: 220px;"
                            ...
                            <li class="dropdown-item hs-has-sub-menu">
                              ...
                              <ul id="navSubmenuBlogClassic" class="hs-sub-menu list-unstyled u-header__sub-menu u-header__sub-menu-offset" style="min-width: 220px;"
                                ...
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/blog/classic-left-sidebar.html">Left Sidebar</a>
                                </li>
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/blog/classic-right-sidebar.html">Right Sidebar</a>
                                </li>
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/blog/classic-full-width.html">Full Width</a>
                                </li>
                              </ul>
                              <!-- End Submenu (level 2) -->
                            </li>
                            ...
                            <li class="dropdown-item hs-has-sub-menu">
                              ...
                              <ul id="navSubmenuBlogGrid" class="hs-sub-menu list-unstyled u-header__sub-menu u-header__sub-menu-offset" style="min-width: 220px;"
                                ...
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/blog/grid-left-sidebar.html">Left Sidebar</a>
                                </li>
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/blog/grid-right-sidebar.html">Right Sidebar</a>
                                </li>
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/blog/grid-full-width.html">Full Width</a>
                                </li>
                              </ul>
                              <!-- End Submenu (level 2) -->
                            </li>
                            ...
                            <li class="dropdown-item hs-has-sub-menu">
                              ...
                              <ul id="navSubmenuBlogList" class="hs-sub-menu list-unstyled u-header__sub-menu u-header__sub-menu-offset" style="min-width: 220px;"
                                ...
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/blog/list-left-sidebar.html">Left Sidebar</a>
                                </li>
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/blog/list-right-sidebar.html">Right Sidebar</a>
                                </li>
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/blog/list-full-width.html">Full Width</a>
                                </li>
                              </ul>
                              <!-- End Submenu (level 2) -->
                            </li>
                            ...
                            <li class="dropdown-item hs-has-sub-menu">
                              ...
                              <ul id="navSubmenuBlogGridMinimal" class="hs-sub-menu list-unstyled u-header__sub-menu u-header__sub-menu-offset" style="min-width: 220px;"
                                ...
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/blog/masonry-left-sidebar.html">Left Sidebar</a>
                                </li>
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/blog/masonry-right-sidebar.html">Right Sidebar</a>
                                </li>
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/blog/masonry-full-width.html">Full Width</a>
                                </li>
                              </ul>
                              <!-- End Submenu (level 2) -->
                            </li>
                            ...
                            <li class="dropdown-item hs-has-sub-menu">
                              ...
                              <ul id="navSubmenuBlogGridMasonry" class="hs-sub-menu list-unstyled u-header__sub-menu u-header__sub-menu-offset" style="min-width: 220px;"
                                ...
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/blog/single-article-classic.html">Classic</a>
                                </li>
                                <li class="dropdown-item u-header__sub-menu-list-item">
                                  <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/blog/single-article-simple.html">Simple</a>
                                </li>
                              </ul>
                              <!-- End Submenu (level 2) -->
                            </li>
                        ...
                        <li class="nav-item hs-has-sub-menu u-header__nav-item"
                          ...
                          <ul id="shopSubMenu" class="list-inline hs-sub-menu u-header__sub-menu mb-0" style="min-width: 220px;"
                            ...
                            <li class="dropdown-item u-header__sub-menu-list-item py-0">
                              <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/shop/classic.html">Classic</a>
                            </li>
                            <li class="dropdown-item u-header__sub-menu-list-item py-0">
                              <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/shop/single-product.html">Single Product</a>
                            </li>
                            <li class="dropdown-item u-header__sub-menu-list-item py-0">
                              <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/shop/checkout.html">Checkout</a>
                            </li>
                            <li class="dropdown-item u-header__sub-menu-list-item py-0">
                              <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/shop/empty-cart.html">Empty Cart</a>
                            </li>
                            <li class="dropdown-item u-header__sub-menu-list-item py-0">
                              <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/shop/gift-card.html">Gift Card</a>
                            </li>
                            <li class="dropdown-item u-header__sub-menu-list-item py-0">
                              <a class="nav-link u-header__sub-menu-nav-link" href="https://htmlstream.com/preview/space-v1.1/html/shop/order-completed.html">Order Completed</a>
                            </li>
                          </ul>
                        </li>
                        <!-- End Shop -->
                        ...
                        <li class="nav-item u-header__nav-item">
                          <a class="nav-link u-header__nav-link" href="https://htmlstream.com/preview/space-v1.1/starter/index.html">
                            Starter
                          </a>
                        </li>
                        <!-- End Starter - Link -->
              ...
              <div class="col-lg-4 order-lg-1 d-flex align-items-start flex-column">
                ...
                <div class="btn-group d-block position-relative mb-4 mb-lg-auto">
                  ...
                  <div id="footerLanguage" class="u-unfold u-unfold--language bottom-0 left-0" aria-labelledby="footerLanguageInvoker">
                    <div class="py-6 px-5">
                      ...
                      <div class="row">
                        <div class="col-6">
                          ...
                          <div class="list-group list-group-borderless list-group-flush">
                            <a class="active d-flex align-items-center list-group-item list-group-item-action" href="#">
                              <img class="max-width-3 mr-2" src="https://htmlstream.com/preview/space-v1.1/assets/vendor/flag-icon-css/flags/4x3/us.svg" alt="United States Flag">
                              English
                            </a>
                            <a class="d-flex align-items-center list-group-item list-group-item-action" href="#">
                              <img class="max-width-3 mr-2" src="https://htmlstream.com/preview/space-v1.1/assets/vendor/flag-icon-css/flags/4x3/fr.svg" alt="France Flag">
                              Français
                            </a>
                            <a class="d-flex align-items-center list-group-item list-group-item-action" href="#">
                              <img class="max-width-3 mr-2" src="https://htmlstream.com/preview/space-v1.1/assets/vendor/flag-icon-css/flags/4x3/de.svg" alt="Germany Flag">
                              Deutsch
                            </a>
                            <a class="d-flex align-items-center list-group-item list-group-item-action" href="#">
                              <img class="max-width-3 mr-2" src="https://htmlstream.com/preview/space-v1.1/assets/vendor/flag-icon-css/flags/4x3/pt.svg" alt="Portugal Flag">
                              Português
                            </a>
                          </div>
                        ...
                        <div class="col-6">
                          ...
                          <div class="list-group list-group-borderless list-group-flush">
                            <a class="d-flex align-items-center list-group-item list-group-item-action" href="#">
                              <img class="max-width-3 mr-2" src="https://htmlstream.com/preview/space-v1.1/assets/vendor/flag-icon-css/flags/4x3/es.svg" alt="Spain Flag">
                              Español
                            </a>
                            <a class="d-flex align-items-center list-group-item list-group-item-action" href="#">
                              <img class="max-width-3 mr-2" src="https://htmlstream.com/preview/space-v1.1/assets/vendor/flag-icon-css/flags/4x3/it.svg" alt="Italy Flag">
                              Italiano
                            </a>
                            <a class="d-flex align-items-center list-group-item list-group-item-action" href="#">
                              <img class="max-width-3 mr-2" src="https://htmlstream.com/preview/space-v1.1/assets/vendor/flag-icon-css/flags/4x3/ru.svg" alt="Russian Flag">
                              Русский
                            </a>
                            <a class="d-flex align-items-center list-group-item list-group-item-action" href="#">
                              <img class="max-width-3 mr-2" src="https://htmlstream.com/preview/space-v1.1/assets/vendor/flag-icon-css/flags/4x3/tr.svg" alt="Turkey Flag">
                              Türkçe
                            </a>
                          </div>
                          <!-- End List of Languages -->
                    ...
                    <!-- Signup -->
                    <a class="u-unfold--language__link p-5" href="https://htmlstream.com/preview/space-v1.1/html/pages/signup-simple.html">
                ...
                <div class="js-scrollbar u-sidebar__body">
                  <div class="u-sidebar__content py-5">
                    ...
                    <ul class="list-unstyled font-size-14 mb-5">
                      <li>
                        <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                          <img class="max-width-4 mr-3" src="https://htmlstream.com/preview/space-v1.1/assets/svg/components/finance-dark-icon.svg" alt="Image Description">
                      ...
                      <li>
                        <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                          <img class="max-width-4 mr-3" src="https://htmlstream.com/preview/space-v1.1/assets/svg/components/touch-dark-icon.svg" alt="Image Description">
                          <div class="media-body">
                            <span>Activity</span>
                          </div>
                        </a>
                      ...
                      <li>
                        <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                          <img class="max-width-4 mr-3" src="https://htmlstream.com/preview/space-v1.1/assets/svg/components/team-dark-icon.svg" alt="Image Description">
                          <div class="media-body">
                            <span>Team</span>
                          </div>
                        </a>
                      ...
                      <li>
                        <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                          <img class="max-width-4 mr-3" src="https://htmlstream.com/preview/space-v1.1/assets/svg/components/email-dark-icon.svg" alt="Image Description">
                          <div class="media-body">
                            <span>Mailbox</span>
                          </div>
                        </a>
                      ...
                      <li>
                        <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                          <img class="max-width-4 mr-3" src="https://htmlstream.com/preview/space-v1.1/assets/svg/components/projects-dark-icon.svg" alt="Image Description">
                          <div class="media-body">
                            <span>Projects</span>
                          </div>
                        </a>
                    ...
                    <ul class="list-unstyled font-size-14 mb-0">
                      <li>
                        <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                          <img class="max-width-4 mr-3" src="https://htmlstream.com/preview/space-v1.1/assets/svg/components/calendar-dark-icon.svg" alt="Image Description">
                          <div class="media-body">
                            <span>Calendar</span>
                          </div>
                        </a>
                      ...
                      <li>
                        <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                          <img class="max-width-4 mr-3" src="https://htmlstream.com/preview/space-v1.1/assets/svg/components/cog-dark-icon.svg" alt="Image Description">
                          <div class="media-body">
                            <span>Tools</span>
                          </div>
                        </a>
                      ...
                      <li>
                        <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                          <img class="max-width-4 mr-3" src="https://htmlstream.com/preview/space-v1.1/assets/svg/components/archive-dark-icon.svg" alt="Image Description">
                          <div class="media-body">
                            <span>Archive</span>
                          </div>
                        </a>
              ...
              <footer class="u-sidebar__footer u-sidebar__footer--panel py-4 px-5">
                ...
                <ul class="list-inline font-size-14 mb-0">
                  <li class="list-inline-item">
                    <a class="u-sidebar--panel__link pr-2" href="https://htmlstream.com/preview/space-v1.1/html/pages/privacy.html">Privacy</a>
                  </li>
                  <li class="list-inline-item">
                    <a class="u-sidebar--panel__link px-2" href="https://htmlstream.com/preview/space-v1.1/html/pages/terms.html">Terms</a>
                  </li>
                  <li class="list-inline-item">
                    <a class="u-sidebar--panel__link pl-2" href="https://htmlstream.com/preview/space-v1.1/html/pages/help.html">
        ...
        <script src="{{ asset('public/vendor/jquery-migrate/dist/jquery-migrate.min.js') }}"></script>
        ...
        <script src="{{ asset('public/vendor/hs-megamenu/src/hs.megamenu.js') }}"></script>
        <script src="{{ asset('public/vendor/jquery-validation/dist/jquery.validate.min.js') }}"></script>
        <script src="{{ asset('public/vendor/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js') }}"></script>
        <script src="{{ asset('public/vendor/custombox/dist/custombox.min.js') }}"></script>
        <script src="{{ asset('public/vendor/custombox/dist/custombox.legacy.min.js') }}"></script>
        <script src="{{ asset('public/vendor/slick-carousel/slick/slick.js') }}"></script>
        <script src="{{ asset('public/vendor/dzsparallaxer/dzsparallaxer.js') }}"></script>
        <script src="{{ asset('public/vendor/cubeportfolio/js/jquery.cubeportfolio.min.js') }}"></script>
        <script src="{{ asset('public/vendor/player.js/dist/player.min.js') }}"></script>

        <!-- JS Space -->
        <script src="{{ asset('public/js/hs.core.js') }}"></script>
        <script src="{{ asset('public/js/components/hs.header.js') }}"></script>
        <script src="{{ asset('public/js/components/hs.unfold.js') }}"></script>
        <script src="{{ asset('public/js/components/hs.validation.js') }}"></script>
        <script src="{{ asset('public/js/helpers/hs.focus-state.js') }}"></script>
        <script src="{{ asset('public/js/components/hs.malihu-scrollbar.js') }}"></script>
        <script src="{{ asset('public/js/components/hs.modal-window.js') }}"></script>
        <script src="{{ asset('public/js/components/hs.show-animation.js') }}"></script>
        <script src="{{ asset('public/js/components/hs.slick-carousel.js') }}"></script>
        <script src="{{ asset('public/js/components/hs.cubeportfolio.js') }}"></script>
        <script src="{{ asset('public/js/components/hs.video-player.js') }}"></script>
        <script src="{{ asset('public/js/components/hs.go-to.js') }}"></script>
