...
@section('content')
    ...
    <!-- Main content-->
    <form method="post" action="{{ url('admin/category/create/'.$type.'/'.$id.'')}}" role="form">
            ...
            <div class="col-lg-12">
                <div class="view-header">
                    <div class="pull-right text-right" style="line-height: 14px;margin-top: 9px;">
                        ...
                        <a href="{{ url('admin/category/product') }}" class="btn" ><i class="fa fa-arrow-left"></i> Geri</a>
                    ...
                    <div class="header-title">
                        ...
                        <small>Kategorileri Buradan Ekleyebilirsiniz</small>
                    </div>
                </div>
                <hr>
            </div>
