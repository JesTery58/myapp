...
@section('content')
    ...
    <form method="post" action="{{ url('admin/language-setting/langedit/'.$id.'')}}" role="form">
                ...
                <div class="view-header">
                    ...
                    <div class="header-title">
                        <h3 class="font-light m-b-xs">
                           <b style="text-transform: uppercase">{{ $id }}</b> Dil Dosyası
                        </h3>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <textarea name="roboticerik" class="form-control" rows="15">
                    {{ File::get(resource_path('lang/'.$id.'/words.php')) }}
                </textarea>
