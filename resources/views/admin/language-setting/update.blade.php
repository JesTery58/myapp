...
<!-- Main content-->
<form method="post" action="{{ url('admin/language-setting/update/'.$id.'')}}" role="form">
                    ...
                    <div id="tab-1" class="tab-pane active">
                        ...
                        <div class="panel-body">
                            <div class="form-group"><label class="col-sm-2 control-label">Adı</label>
                                <div class="col-sm-10">
                                    <div class="input-group m-b"><span class="input-group-addon"></span> <input type="text" name="name" value="{{ $languages_setting->name }}" class="form-control" ></div>
                                </div>
                            </div>
                            <div class="form-group"><label class="col-sm-2 control-label">Dil Kodu</label>
                                <div class="col-sm-10">
                                    <div class="input-group m-b"><span class="input-group-addon"></span> <input type="text" name="code" value="{{ $languages_setting->code }}" class="form-control" ></div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group m-b"><span class="input-group-addon"></span>
                                        <select type="text" name="status"  class="form-control" >
                                            <option value="1" @if( $languages_setting->status == 1) selected @endif >Aktif</option>
                                            <option value="0" @if( $languages_setting->status == 0) selected @endif>Pasif</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group"><label class="col-sm-2 control-label">Bayrak Resmi</label>
                                <div class="col-sm-10">
                                    <a onclick="sunucuyaGozat('{{ url('/admin/file-directory')}}', 101)" href="javascript:void(0);">
                                        <div id="101"><img src="{{ $languages_setting->image }}" width="30" onerror="this.src='{{ url('public/img/yukle.png') }}"></div>
                                        <input type="hidden" id="101a" placeholder="Resim Ekle" name="image" 	value="{{ $languages_setting->image}}" />
                                    </a>
                                </div>
                            </div>
