...
@section('content')
    ...
    <!-- Main content-->
    <form method="post" action="{{ url('admin/products/create')}}" role="form">
            ...
            <div class="col-lg-12">
                <div class="view-header">
                    ...
                    <div class="header-title">
                        ...
                        <small>Yeni Ürün Bilgilerini Buardan Ekleyebilirsiniz</small>
                    </div>
                </div>
                <hr>
            </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="tab-1" class="tab-pane active">
                            ...
                            <div class="panel-body">
                                            ...
                                            @foreach ($categories as $category)
                                                <li>
                                                    <div style="float: left">
                                                        <input type="checkbox" name="parent_id" value="{{ $category->seo_url }}" class="" >
                                                    </div>
                                                    <div style="margin-left: 20px;">{{ unserialize($category->name)['tr'] }} </div>
                                                    @if($category->children ->isNotEmpty())
                                                        @include ('/admin/category/sub_list_check' , [ 'children' => $category->children , 'control_id'=> '' ] )
                                                    @endif
                                                </li>
                                            @endforeach
                                        </ul>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Ürün Fiyatı</label>
                                    <div class="col-sm-10">
                                        <div class="input-group m-b"><span class="input-group-addon"></span> <input type="text" name="price" value="" class="form-control" ></div>
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-sm-2 control-label">Sıra Numarası</label>
                                    <div class="col-sm-10">
                                        <div class="input-group m-b"><span class="input-group-addon"></span> <input type="text" name="orders" value="{{old('orders')}}" class="form-control" ></div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group"><label class="col-sm-2 control-label">İçerik</label>
                                        <div class="col-sm-10">
                                            <div class="input-group m-b"><span class="input-group-addon"></span>
                                                <textarea type="text" name="comment[{{ $language->code }}]" value="" class="form-control"  rows="10"></textarea></div>
                                        </div>
                                    </div>
                                    <div class="form-group"><label class="col-sm-2 control-label">Özellikler</label>
                                        <div class="col-sm-10">
                                            <div class="input-group m-b"><span class="input-group-addon"></span>
                                                <textarea type="text" name="features[{{ $language->code }}]" value="" class="form-control"  rows="10"></textarea></div>
                                        </div>
                                    </div>
                        ...
                        <div id="tab-image" class="tab-pane">
                            <div class="panel-body">
                                ...
                                <div class="col-md-12" id="tablobody"></div>
                             </div>
                        </div>
