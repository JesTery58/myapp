...
<!-- Main content-->
<form method="post" action="{{ url('admin/slider/update/'.$id.'')}}" role="form">
        ...
        <div class="col-lg-12">
            <div class="view-header">
                ...
                <div class="header-title">
                    ...
                    <small>Dil Bilgilerini Buardan Güncelleyebilirsiniz</small>
                </div>
            </div>
            <hr>
        </div>
                    ...
                    <div id="tab-1" class="tab-pane active">
                        ...
                        <div class="panel-body">
                            <div class="form-group"><label class="col-sm-2 control-label">Sıra Numarası</label>
                                <div class="col-sm-10">
                                    <div class="input-group m-b"><span class="input-group-addon"></span> <input type="text" name="orders" value="{{ $slider->orders }}" class="form-control" ></div>
                                </div>
                            </div>
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label">URL</label>
                                <div class="col-sm-10">
                                    <div class="input-group m-b"><span class="input-group-addon"></span> <input type="text" name="url" value="{{ $slider->url }}" class="form-control" ></div>
                                </div>
                            </div>
                            <div class="form-group"><label class="col-sm-2 control-label">Slider Resmi</label>
                                <div class="col-sm-10">
                                    <a onclick="sunucuyaGozat('{{ url('/admin/file-directory')}}', 101)" href="javascript:void(0);">
                                        <div id="101"><img src="{{ asset(''.$slider->image.'') }}" width="200" onerror="this.src='{{ url('public/img/yukle.png') }}"></div>
                                        <input type="hidden" id="101a" placeholder="Resim Ekle" name="image" 	value="{{ $slider->image}}" />
                                    </a>
                                </div>
                            </div>
                        ...
                        <div id="tab-{{ $language->code }}" class="tab-pane">
                            <div class="panel-body">
                                <div class="form-group"><label class="col-sm-2 control-label">Başlık</label>
                                    <div class="col-sm-10">
                                        <div class="input-group m-b"><span class="input-group-addon"></span> <input type="text" name="caption[{{ $language->code }}]" value="{{ unserialize($slider->caption)[$language->code] ?? '' }}" class="form-control" ></div>
                                    </div>
                                </div>

                                <div class="form-group"><label class="col-sm-2 control-label">Başlık Alt Yazısı</label>
                                    <div class="col-sm-10">
                                        <div class="input-group m-b"><span class="input-group-addon"></span> <input type="text" name="caption_two[{{ $language->code }}]" value="{{ unserialize($slider->caption_two)[$language->code] ?? '' }}" class="form-control" ></div>
                                    </div>
                                </div>
